...
#' 
#' @author Paul Kienzle \email{pkienzle@@users.sf.net}, Pascal Dupuis
#'   \email{Pascal.Dupuis@@esat.kuleuven.ac.be}, port to R Tom Short. Minor
#'   changes by Geert van Boxtel \email{G.J.M.vanBoxtel@@gmail.com}.
#' 
#' @export
