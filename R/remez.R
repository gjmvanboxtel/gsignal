...
#' @param ftype filter type, matched to one of "bandpass" (default),
...
#'   \code{\link{fir1}}
#' 
#' @author Original Octave code by Jake Janovetz \email{janovetz@@uiuc.edu},
#'   Paul Kienzle \email{pkienzle@@users.sf.net}, Kai Habel
#'   \email{kahacjde@@linux.zrz.tu-berlin.de}. Port to R Tom Short, slightly
