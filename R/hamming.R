...
#' 
#' The Hamming window is a member of the family of cosine sum windows. If you specify a one-point window \code{(n = 1)},
...
#' }
#' 
#' @return Hamming window, returned as a vector.
#' 
#' @examples
#' 
#' h <- hamming(64)
