...
#'
#' @param z Vector, matrix, or array of complesinglex numbers.
#' @param tol Weighting factor \code{0 < tol < 1}, which determines the
#'   tolerance of matching. Default: 100 * .Machine$double.eps. (This definition
#'   differs from the Octave usage).
#' @param dim Dimension along which to sort the complex pairs. Default: 2
#'   (columns).
#'
#' @return Vector, matrix or array containg ordered complex conjugate pairs by
