...
#'   weights the mean squared error in that band. \code{w} must be half the length of \code{f}.
#' 
...
#'   \code{\link{fir1}}
#' 
#' @author Original Octave code by Quentin Spencer \email{qspencer@@ieee.org},
