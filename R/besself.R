...
#' wave shape of filtered signals in the passband.
#' 
...
#'   Doug Stewart \email{dastew@@sympatico.ca}, Thomas Sailer
#'   \email{t.sailer@@alumni.ethz.ch}. Port to R by Geert van Boxtel
