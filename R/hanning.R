...
#' 
#' The Hann window is a member of the family of cosine sum windows. It was named after Julius von Hann, and is sometimes referred
#' to as Hanning, presumably due to its linguistic and formulaic similarities to Hamming window.
#' 
