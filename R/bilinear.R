...
#' filter with band edges in the s-plane positioned at \eqn{2/T tan(w*T/2)} so
...
#' @param T the sampling frequency represented in the z plane. Default: 2 *
#'   tan(1/2).
#' @param ...	arguments passed to the generic function.
#' 
#' @return For the default case or for bilinear.Zpg, an object of class 'Zpg',
