...
#' 
#' @return Vector of reducd polynimial coefficients.
#' 
#' @examples
#' polyreduce(c(0, 0, 1, 2, 3))
#' 
#' @author Original Octave version by Tony Richardson
#'   \email{arichard@@stark.cc.oh.us}, adapted by John W. Eaton. Conversion to R
#'   by Geert van Boxtel \email{G.J.M.vanBoxtel@@gmail.com}
#
#' @export
