...
[![Codecov test coverage](https://codecov.io/gh/gjmvanboxtel/gsignal/branch/master/graph/badge.svg)](https://app.codecov.io/gh/gjmvanboxtel/gsignal?branch=master)
<!-- badges: end -->
...
The latest development version can be downloaded directly from [GitHub](https://github.com/gjmvanboxtel/gsignal):
...
An overview of the functions in the package is available in the [vignette](https://CRAN.R-project.org/package=gsignal).
